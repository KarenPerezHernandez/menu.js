...
//Que hace? se crea un ele,ento table para cada categoria. ademas, se prepara el encabezado (tableHead) con las columnas pertinentes. table body se inicializa vacio y se llenara con los elementos de la categoria.
